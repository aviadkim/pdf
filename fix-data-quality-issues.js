...
console.log('📊 ISSUES IDENTIFIED FROM REAL TEST:');
console.log('1. ❌ Repeated values ($366,223 appears multiple times)');
console.log('2. ❌ Generic names ("GOLDMAN SACHS" instead of specific instruments)'); 
console.log('3. ❌ Missing currency information');
console.log('4. ❌ Missing detailed instrument descriptions');
console.log('5. ❌ Some values might be using wrong parsing logic\n');
...
console.log('📝 Created improved extraction function');
console.log('✅ Addresses repeated values');
console.log('✅ Improves name extraction'); 
console.log('✅ Adds currency, maturity, coupon detection');
console.log('✅ Better value parsing with multiple strategies');
console.log('✅ Duplicate detection and correction');

// Save the improved function
fs.writeFileSync('improved-extraction-function.js', improvedExtraction);

console.log('\n💾 Improved extraction function saved to: improved-extraction-function.js');
console.log('🔧 Next step: Integrate this into the working system');

console.log('\n🎯 EXPECTED IMPROVEMENTS:');
console.log('• Unique values instead of repeated $366,223');
console.log('• Detailed names like "GOLDMAN SACHS 4.25% STRUCTURED NOTES 2027"');
console.log('• Currency information (USD/CHF/EUR)');
console.log('• Maturity dates where available'); 
console.log('• Coupon rates where available');
console.log('• Better value accuracy through multi-strategy extraction');