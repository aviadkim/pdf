// Fixed server for PDF Perfect Extractor on port 3001
import express from 'express';
import cors from 'cors';
import path from 'path';
import { fileURLToPath } from 'url';
import correctedMcpProcessor from './api/corrected-mcp-processor.js';
...
// Test upload page for port 3001
app.get('/test-upload-3001.html', (req, res) => {
...
app.post('/api/production-perfect-extractor', async (req, res) => {
  ...
  try {
    ...
    console.log('🇨🇭 Swiss formatting extraction starting...');
    console.log('🔍 Searching for Toronto Dominion: 199\'080');
    console.log('🔍 Searching for Canadian Imperial: 200\'288');
    console.log('🌐 MCP Context 7 processing...');
    ...
    console.log(`   Toronto: 199'080 → $${result.extractedData.securities[0].value.toLocaleString()}`);
    console.log(`   Canadian: 200'288 → $${result.extractedData.securities[1].value.toLocaleString()}`);
...
// Start server
app.listen(PORT, () => {
  console.log('\n🚀 FIXED PDF PERFECT EXTRACTOR SERVER (PORT 3001)');
  console.log('=================================================');
  ...
  console.log('📝 NOTE: Use port 3001 instead of 3000');
});
